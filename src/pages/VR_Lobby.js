            ...
            <div className="my-container">
                ...
                <a-scene>
                    ...
                    <a-plane material="opacity:0.4:transparent:true" position="2 1 -3" scale="2 1 0" rotation="0 -35 0 ">
                        ...
                        <a-plane clickpause_play material="opacity:.9:transparent:true" class="clickable" position="0 0 -500" scale=".14 .2 .1" rotation="0 0 0" src="/img/play-pause.svg" repeat="1 1 1" />

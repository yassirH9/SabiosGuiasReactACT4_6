            ...
            <div className="my-container">
                ...
                <a-scene>
                    ...
                    <a-plane material="opacity:0.4:transparent:true" position="2 1 -3" scale="2 1 0" rotation="0 -35 0 ">
                        ...
                        <a-plane material="opacity:.9:transparent:true" class="clickable" home position=".40 -.35 -500" scale=".12 .24 .1" rotation="0 0 0" src="/img/LogoSabiosGuiasCompact.png" repeat="1 1 1"/>
